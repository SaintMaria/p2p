...
public class ClientImpl extends UnicastRemoteObject implements ClientI  {
    ...
    public boolean run(){//el metodo principal
		...
		String filename;
                ...
                try {
                    ...
                    System.out.println("1 - Buscar un Archivo");
                    System.out.println("2 - Descargar Archivo");
                    System.out.println("3 - Archivos que se encuentran en el directorio");
                    ...
                    switch (choice) {
                        ...
                        case 2:
                            System.out.print("Inserte Nombre del Archivo: ");
                            filename = in.readLine();
                            getFile(filename);
	 ...
	 */
		...
		System.out.println("\n\nArchivos compartidos en el Directorio: ");
	...
	private void register(File dir){ //registra todos los archivos del directorio
		...
		if (sharedfiles.length == 0) {
                ...
                System.out.println("# de archivos registrados: " + totalSF);
